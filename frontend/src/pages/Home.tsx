          ...
          <div>
            <div className="flex items-start justify-between mb-8">
              ...
              <div className="flex gap-3">
                <a
                  href="/documents"
                  className="bg-indigo-600 text-white px-5 py-2.5 rounded-xl font-semibold flex items-center gap-2 hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/20"
                >
                  <FolderOpen size={18} /> Ver Documentos
                </a>
                <button
                  onClick={() => setIsUploadModalOpen(true)}
            ...
            <div className="p-20 text-center bg-white border border-gray-100 shadow-sm rounded-3xl">
              ...
              <p className="text-gray-400 mb-4">Gestiona tus documentos con categorías y búsqueda avanzada.</p>
              <a
                href="/documents"
                className="inline-flex items-center gap-2 px-6 py-3 text-white bg-indigo-600 rounded-xl font-semibold hover:bg-indigo-700 transition-colors"
              >
                <FolderOpen size={20} />
                Ir a Mis Documentos
              </a>
